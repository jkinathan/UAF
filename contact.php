...
<body>
        ...
        <div class="container">
            ...
            <div class="col-md-3 p0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="images/favicon.png" alt="Logo"></a>
                </div>
            </div>
            ...
            <div class="col-md-9 p0">
                <div class="collapse navbar-collapse" id="min_navbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="onlineform.html">Register</a></li>
                        <li class="dropdown submenu">
    ...
    <!-- All contact Info -->
    <section class="all_contact_info"  style="background-image: url(images/u1.jpg);">
        <div class="container">
            <div class="row contact_row">
                <div class="col-sm-5 contact_info">
                    ...
                    <div class="location">
                        ...
                        <div class="address">
                            <p>Metropole House, Ground Floor, Suite G10. Plot 8/10 Entebbe Road, Kampala.</p>
                            <p>0-414-340342</p>
                            <p>info@athleticsuganda.org</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-7 contact_info send_message"  style="background-color: rgba(0,0,0,0.4); padding: 60px;">
                    <h2>Have a Message?</h2>
                    <form class="form-inline contact_box" action="contact.php" method="POST">
                        <input type="text" class="form-control input_box" name="name" placeholder="Name .... *" required="" maxlength="35">
                        <input type="text" class="form-control input_box" name="email" placeholder="Your Email " maxlength="40">
                        <textarea class="form-control input_box" name="message" placeholder="Message *" minlength="25" maxlength="800" required=""></textarea>
