        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="contactAdmin.php" class="active-menu"><i class="fa fa-qrcode"></i>Customer Contact Details</a>
                    </li>
                    
                    <li>
                        <a href="table.php"><i class="fa fa-table"></i> Athletes Data</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
			  <div class="header"> 
                        <h1 class="page-header">
                            Contact Details <small>Information</small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
