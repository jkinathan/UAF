...
if(isset($_POST['register'])){
    ...
    if(isset($_POST['activities'])){
      $dbCheckbox = implode(',',$_POST['activities']);
    }
    
    
    if(!empty($username) && !empty($bipno) && !empty($club)){
        
      
        $sql = "INSERT INTO RegisterRunner(Name,BipNumber,ClubName,AllTrails,Activities) values ('$username','$bipno','$club','$category','$dbCheckbox')";
        
        if($conn->query($sql))
		{
      echo("\n <br>Athlete created successfully");
      
		}
		else
		{
			echo("Error:".$sql."<br>".$conn->conn_error);
		}
    ...
    <!-- End Banner area -->
          ...
          <div class="tab">
                ...
                <select name="category" id="category" required="">
                        ...
                        <option value="1st National Trials (Paralympic Trials)">1st National Trials (Paralympic Trials)</option>
                        <option value="2nd National Trials (Athletics Conference)">2nd National Trials (Athletics Conference)</option>
                        <option value="3rd National Trials">3rd National Trials</option>
                        <option value="4th National Trials">4th National Trials</option>
                        <option value="5th National Trials">5th National Trials</option><br/><br/>
                        <option value="21st Akii Bua Memorial Championship/ Central Region Championship">21st Akii Bua Memorial Championship/ Central Region Championship</option>
                        <option value="National Track & Field Championship">National Track & Field Championship</option>
                </select><br/><br/>
                <hr/>
              ...
              <div class="row contact_row">
                <div class="col-sm-6 contact_info">
                        ...
                        <label class="cont">100M(Men / Women)
                          <input type="checkbox" name="activities[]" value="100M(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">200m (Men / Women)
                          <input type="checkbox" name="activities[]" value="200M(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                         <label class="cont">400m (Men / Women)
                          <input type="checkbox" name="activities[]" value="400M(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">800m (Men / Women)
                          <input type="checkbox" name="activities[]" value="800M(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">1500m (Men / Women)
                          <input type="checkbox" name="activities[]" value="1500M(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">3000m SC (Men / Women)
                          <input type="checkbox" name="activities[]" value="3000M SC(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">5000m (Men / Women)
                          <input type="checkbox" name="activities[]" value="5000M(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">10000m (Men / Women)
                          <input type="checkbox" name="activities[]" value="1000M(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">High Jump (Men / Women)
                          <input type="checkbox" name="activities[]" value="High Jump(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                ...
                <div class="col-sm-6 contact_info send_message">
                        <label class="cont">Long Jump (Men / Women)
                          <input type="checkbox"name="activities[]" value="long Jump(Men / Women)">
                          <span class="checkmark"></span>
                        </label><label class="cont">Shot Put (Men / Women)
                          <input type="checkbox" name="activities[]" value="Shot Put(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">Javelin (Men / Women)
                          <input type="checkbox" name="activities[]" value="Javelin(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">Discuss (Men / Women)
                          <input type="checkbox" name="activities[]" value="Discuss(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">Tripple Jump (Men / Women)
                          <input type="checkbox" name="activities[]" value="Triple Jump(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                         <label class="cont">4*400m Relay (Men / Women)
                          <input type="checkbox" name="activities[]" value="4*400m Relay(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">4*100m Relay (Men / Women)
                          <input type="checkbox" name="activities[]" value="4*100M(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">100m Hurdles (Men / Women)
                          <input type="checkbox" name="activities[]" value="100M Hurdles(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                        <label class="cont">400m Hurdles (Men / Women)
                          <input type="checkbox" name="activities[]" value="400M Hurdles(Men / Women)">
                          <span class="checkmark"></span>
                        </label>
                </div>
            </div>           
